...
char CathodeNumber[] = {0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F,0x7F}; //0 - 9,dp
...
void LED7SEG_Scan4Led(LED7SEG_Num* LED7_NUM, LED7SEG_Device_Name* LED7SEG, uint16_t number)
{
	...
	//LED7SEG_WriteOneNumber(LED7SEG, 9);
    //HAL_Delay(5); // Thời gian quét
	...
	//LED7SEG_WriteOneNumber(LED7SEG, 6);
    //HAL_Delay(5); // Thời gian quét
	...
	//LED7SEG_WriteOneNumber(LED7SEG, 4);
    //HAL_Delay(5); // Thời gian quét

	HAL_GPIO_WritePin(LED7_NUM->LED3, LED7_NUM->LED3_pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(LED7_NUM->LED4, LED7_NUM->LED4_pin, GPIO_PIN_RESET);
	LED7SEG_WriteOneNumber(LED7SEG, number_convert.Uints);
	//LED7SEG_WriteOneNumber(LED7SEG, 8);
    //HAL_Delay(5); // Thời gian quét
